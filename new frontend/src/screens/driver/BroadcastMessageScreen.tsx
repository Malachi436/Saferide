            ...
            <LiquidGlassCard intensity="medium" className="mb-4">
              <View style={styles.headerCard}>
                <View style={styles.iconCircle}>
                  <Ionicons name="megaphone" size={28} color={colors.accent.safetyOrange} />
                </View>
            ...
            <View style={styles.recipientHeader}>
              ...
              <Pressable onPress={toggleSelectAll} style={styles.selectAllButton}>
                <Ionicons
                  ...
                  size={20}
                  color={selectAll ? colors.primary.yellow : colors.neutral.textSecondary}
                />
                <Text
                  style={[
                    styles.selectAllText,
                    selectAll && { color: colors.primary.yellow },
                  ]}
                >
                  Select All
                </Text>
                    ...
                    >
                      ...
                      >
                        ...
                        <View style={styles.childrenBadge}>
                          <Ionicons name="people" size={14} color={colors.primary.yellow} />
