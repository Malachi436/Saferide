            ...
            <View style={styles.settingsGroup}>
              <View style={styles.settingItem}>
                ...
                <Switch
                  ...
                  thumbColor={shareLocation ? colors.status.success : colors.neutral.pureWhite}
              ...
              <View style={styles.settingItem}>
                <View style={styles.settingLeft}>
                  <View style={[styles.settingIcon, { backgroundColor: colors.accent.skyBlue + "20" }]}>
                    <Ionicons name="call" size={20} color={colors.accent.skyBlue} />
                  </View>
                  <View style={styles.settingText}>
                ...
                <Switch
                  ...
                  thumbColor={sharePhoneNumber ? colors.status.success : colors.neutral.pureWhite}
                  ios_backgroundColor={colors.neutral.textSecondary + "40"}
                />
              </View>
              ...
              <View style={styles.settingItem}>
                <View style={styles.settingLeft}>
                  <View style={[styles.settingIcon, { backgroundColor: colors.accent.safetyOrange + "20" }]}>
                    <Ionicons name="chatbubbles" size={20} color={colors.accent.safetyOrange} />
                  </View>
                  <View style={styles.settingText}>
                ...
                <Switch
                  ...
                  thumbColor={allowMessages ? colors.status.success : colors.neutral.pureWhite}
                  ios_backgroundColor={colors.neutral.textSecondary + "40"}
                />
              </View>
            </View>
            ...
            <View style={styles.settingsGroup}>
              <View style={styles.settingItem}>
                ...
                <Switch
                  ...
                  thumbColor={biometricLogin ? colors.status.success : colors.neutral.pureWhite}
                  ios_backgroundColor={colors.neutral.textSecondary + "40"}
                />
              </View>
        ...
        <Animated.View entering={FadeInDown.delay(300).springify()}>
          ...
          <LiquidGlassCard intensity="medium" className="mb-4">
            <View style={styles.settingsGroup}>
              <Pressable style={styles.settingItem}>
                <View style={styles.settingLeft}>
                  <View style={[styles.settingIcon, { backgroundColor: colors.status.info + "20" }]}>
                    <Ionicons name="download" size={20} color={colors.status.info} />
                  </View>
                  <View style={styles.settingText}>
              ...
              <Pressable style={styles.settingItem}>
                <View style={styles.settingLeft}>
                  <View style={[styles.settingIcon, { backgroundColor: colors.status.danger + "20" }]}>
