...
async function main() {
  ...
  // Create a platform admin (global access)
  ...
  // Create a 24/7 TEST route that is ALWAYS active (for testing GPS tracking)
  ...
  // Create a 24/7 TEST TRIP that is ALWAYS IN_PROGRESS (for GPS testing)
